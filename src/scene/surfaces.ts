/**
 * Progressive surface enhancement: AI-generated photographic texture maps
 * (created with Higgsfield, shipped in /public/textures) are streamed in after
 * boot and swapped over the procedural surfaces. If any file fails to load,
